...
export default function BuyersClient({ buyers, puppies, contracts }: any) {
  ...
  const handleSaveAndEmailContract = async () => {
    ...
    try {
      ...
      alert("Szerződés sikeresen archiválva! A bevétel automatikusan könyvelve lett a Finance menüpont alá, a kiskutya státusza 'Sold'-ra változott, and az e-mail kiküldés elindult! 💰🐶✈️");
