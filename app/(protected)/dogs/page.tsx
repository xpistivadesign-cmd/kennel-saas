      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {dogs?.map((dog) => (
            <div
              key={dog.id}
              className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4 hover:border-zinc-700 hover:bg-zinc-800/40 transition"
            >
              <Link
                href={`/dogs/${dog.id}`}
                className="text-xl font-bold text-amber-500 hover:underline"
              >
                {dog.name}
              </Link>
