      ...
      {activeTab === "pedigree" && (
        <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-xl">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs font-mono">
            <div className="bg-black/40 p-4 rounded-xl border border-zinc-800"><span className="text-blue-400 font-bold block text-[10px]">Sire (Father)</span><span className="text-white font-bold text-sm mt-1 block">{dog.sire_name || "Unknown Stud"}</span></div>
            <div className="bg-black/40 p-4 rounded-xl border border-zinc-800"><span className="text-pink-400 font-bold block text-[10px]">Dam (Mother)</span><span className="text-white font-bold text-sm mt-1 block">{dog.dam_name || "Unknown Female"}</span></div>
          </div>
        </div>
      )}
