...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Ide jön majd a Supabase auth logikád, addig is egy szimulált beléptetés:
    setTimeout(() => {
      setLoading(false);
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#030712] font-sans antialiased selection:bg-[#023FF9] selection:text-white overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12 bg-black border-r border-zinc-900">
        ...
        />
        {/* High-tech sötét gradient overlay */}
        ...
        {/* Dekoratív neon háttér fénycsóvák */}
      ...
      {/* ⚡ JOBB OLDAL: GLASSMORPHISM LOGIN CARD */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative">
        {/* Háttér elmosódás kártya mögött */}
        ...
        <div 
          className="w-full max-w-[460px] rounded-[32px] p-8 sm:p-10 relative overflow-hidden transition-all duration-300 border border-zinc-800/80"
          style={{
        ...
        >
          ...
          <div className="space-y-2 mb-8">
            ...
            <p className="text-xs text-zinc-500 font-medium">Add meg a tenyésztői fiókod hozzáférési adatait.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <button 
                  type="button"
                  onClick={() => alert("Jelszó-visszaállító email elküldve a megadott címre!")}
            ...
            {/* BEJELENTKEZÉS CTA BUTTON (Electric Blue fénnyel) */}
            <button
              type="submit"
              disabled={loading}
          ...
          <button
            type="button"
            onClick={() => alert("Google OAuth csatlakozás folyamatban...")}
